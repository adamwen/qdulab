...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'lessons_lesson', (
            ...
            ('total_person', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'lessons', ['Lesson'])

        # Adding M2M table for field users on 'Lesson'
        m2m_table_name = db.shorten_name(u'lessons_lesson_users')
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field users on 'Lesson'
        db.delete_table(db.shorten_name(u'lessons_lesson_users'))
    ...
    models = {
        ...
        u'lessons.lesson': {
            ...
            'total_person': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
